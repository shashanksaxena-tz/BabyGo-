...
const MONGODB_URI = process.env.MONGODB_URI || 'mongodb://localhost:27017/tinysteps';
...
async function seedDoctors() {
  try {
    ...
    console.log('Inserting seed doctors...');
    const inserted = await Doctor.insertMany(doctors);
    console.log(`Successfully inserted ${inserted.length} doctors`);
