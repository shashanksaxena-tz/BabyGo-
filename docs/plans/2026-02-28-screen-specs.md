# Little Leap — Complete Screen Specifications
...
2. Centered vertically: Little Leap logo (stylized baby footprint icon) + app name "Little Leap" in Nunito Bold 28px white.
...
### States
- **Empty** (no child profile): Show illustration of a parent holding a baby + "Welcome to Little Leap!" title + "Add your child's profile to get started" description + "Set Up Profile" emerald button -> Profile Setup (screen 5).
...
- Browser tab title: "Analyzing... | Little Leap"
...
2. **Report content** (scrollable, print-formatted):
   - **Little Leap logo** + "Development Report" header.
   ...
   - **Disclaimer** at bottom:
     - "This report is generated by Little Leap for informational purposes only..."
...
5. **Disclaimer card** at bottom:
   - "Little Leap provides recommendations for informational purposes only. Always consult a licensed healthcare professional."
...
**Purpose**: Display the scientific evidence, methodology, and sources behind Little Leap assessments.
...
4. **About section**:
   - "About Little Leap" (info icon) -> version, licenses.
...
6. **App version**: "Little Leap v1.0.0" centered, 11px, gray, at very bottom.
