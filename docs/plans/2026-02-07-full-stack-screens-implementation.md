# TinySteps AI — Full-Stack Screens Implementation Plan
...
Run:
```bash
cd /Users/shashanksaxena/Documents/Personal/Code/BabyGo-/backend && npm install minio
```
...
```bash
cd /Users/shashanksaxena/Documents/Personal/Code/BabyGo-/backend && node src/scripts/seedDoctors.js
```
...
```bash
cd /Users/shashanksaxena/Documents/Personal/Code/BabyGo-/backend && npm install pdfkit
```
...
async function generateReportPDF(report) {
  return new Promise((resolve, reject) => {
    ...
    // Title
    doc.fontSize(20).font('Helvetica-Bold').text('TinySteps AI - Development Report', { align: 'center' });
    doc.moveDown(0.5);
    ...
    doc.text('Generated by TinySteps AI | WHO-referenced developmental assessment', { align: 'center' });
...
```bash
cd /Users/shashanksaxena/Documents/Personal/Code/BabyGo-/tinysteps_flutter && flutter pub add share_plus path_provider
```
